...
import (
	...
	_ "github.com/mvmaasakkers/protoc-gen-gorm/options"
	math "math"
)
...
func (*ExternalChild) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c28b67338802fea, []int{0}
}
...
func (m *ExternalChild) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExternalChild.Merge(m, src)
}
...
func (*BlogPost) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c28b67338802fea, []int{1}
}
...
func init() {
	proto.RegisterFile("example/feature_demo/demo_multi_file.proto", fileDescriptor_0c28b67338802fea)
}

var fileDescriptor_0c28b67338802fea = []byte{
